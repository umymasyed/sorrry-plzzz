...
export default function Home() {
  ...
  <button
    ...
    className="bg-gradient-to-r from-pink-400 to-rose-400 hover:from-pink-500 hover:to-rose-500 text-white font-semibold py-3 px-10 rounded-full text-lg shadow-md transition-all duration-300 transform hover:scale-110 hover:shadow-xl animate-pulse-heart"
  >
    Yesss 💗
  </button>
  ...
  <button
    ...
    className={`font-semibold py-3 px-10 rounded-full text-lg shadow-md transition-all duration-300 transform hover:scale-105 ${
      response === 'no'
        ? 'bg-pink-200 text-rose-600 animate-bounce'
        : 'bg-white text-rose-400 border-2 border-rose-300 hover:bg-rose-50'
    }`}
  >
    Nooo 🥺
  </button>
