...
export default function Home() {
  ...
  <h1 className="text-3xl md:text-4xl font-extrabold bg-gradient-to-r from-pink-500 via-rose-500 to-pink-400 bg-clip-text text-transparent tracking-wide">
    I&apos;m really sorry... 💔
  </h1>
  ...
  {response === 'no' && (
    <p className="text-sm text-rose-500 font-semibold mt-3 animate-pulse">
      I won&apos;t give up on us… please say yes naaa 💗✨
    </p>
  )}
</div>
        {/* Character Carousel */}
